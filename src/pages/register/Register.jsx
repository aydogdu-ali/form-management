...
theme: "light",
  ...
  return (
    ...
    <div className={RegisterStyle["register"]}> 
      ...
      <Form.Group className="mb-3" >
        <Form.Label className={RegisterStyle["info"]}>Soy Adınız:<span className='text-dark'>{lastName.toLocaleUpperCase()}</span></Form.Label>
      ...
      <Form.Group className="mb-3" >
        <Form.Label className={RegisterStyle["info"]}>Yaşadığınız Şehir:<span className='text-dark'>{city.toLocaleUpperCase()}</span></Form.Label>
      ...
      <Form.Group className="mb-3" >
        <Form.Label className={RegisterStyle["info"]}>Email address:<span className='text-dark'>{email}</span></Form.Label>
      ...
      <Form.Group className="mb-3" >
        <Form.Label className={RegisterStyle["info"]} >Password:<span className='text-dark'>{password}</span></Form.Label>
